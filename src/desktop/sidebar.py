...
class ModernSidebarButton(QPushButton):
    ...
    def setup_style(self):
        ...
        font_size = tokens.fpx(tokens.get_font_size('large'))
        ...
        style = f"""
            QPushButton {{
                ...
                font-weight: 500;
                min-height: {int(35 * scale)}px;
                max-height: {int(35 * scale)}px;
            }}
            QPushButton:hover {{
    ...
    def setup_ui(self):
        ...
        self.setStyleSheet(f"""
            QWidget {{
                ...
                border-right: {tokens.spx(1)}px solid {ModernStyle.COLORS['border']};
            }}
        """)
