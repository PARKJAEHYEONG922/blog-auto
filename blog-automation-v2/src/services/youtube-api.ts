...
export class YouTubeAPI {
  ...
  async extractSubtitlesSimple(videoId: string): Promise<SubtitleTrack[]> {
    try {
      console.log(`🎬 extractSubtitlesSimple 시작: ${videoId}`);
      
      // IPC 통신으로 메인 프로세스에서 자막 추출
      console.log(`🔄 IPC 통신으로 자막 추출 시도: ${videoId}`);
      ...
      console.error(`💥 extractSubtitlesSimple 전체 실패: ${videoId}`, error);
      return [];
    }
  }
}
